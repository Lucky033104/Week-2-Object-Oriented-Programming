...
import java.util.*;
class Course105 {
    private String courseName105;
    private Professor105 assignedProfessor105;
    private List<Student105> enrolledStudents105;
    ...
    public void showCourseDetails105() {
        ...
        if (assignedProfessor105 != null) {
            System.out.println("Taught by: " + assignedProfessor105.getProfessorName105());
        }
...
class Professor105 {
    private String professorName105;
...
class Student105 {
    private String studentName105;
    private List<Course105> enrolledCourses105;
...
public class UniversityManagement {
    public static void main(String[] args) {
        Student105 studentA105 = new Student105("Krishna");
        Student105 studentB105 = new Student105("Lokesh");
        Professor105 professor105 = new Professor105("Dr. Shniy");
