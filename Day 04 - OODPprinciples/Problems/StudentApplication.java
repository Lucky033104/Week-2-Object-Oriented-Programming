...
import java.util.*;
class Course101 {
    private String courseName101;
    private List<Student101> enrolledStudents101;
...
class Student101 {
    ...
    private List<Course101> courses101;
...
class School101 {
    private String schoolName101;
    private List<Student101> students101;
